...
WebUI.setText(findTestObject('Object Repository/Checkout/City_CheckoutPage'), 'zxcvbnmasdfghjklqwertyuiopqwertyuiaasdfgzxcvb')
...
CustomKeywords.'com.helper.common.Common_Helper.highlightElement'(findTestObject('Object Repository/Checkout/City_CheckoutPage'))

//To get the URL and trim the random path
String trimmedUrl = trimRandomPart(WebUI.getUrl())

CustomKeywords.'com.helper.common.Common_Helper.highlightElement'(findTestObject('Object Repository/Checkout/State_CheckoutPage'))
...
if (trimmedUrl != (trimmedUrl2)) {
	...
	KeywordUtil.markFailed('The city text field accepting the more than 35 character. ')
