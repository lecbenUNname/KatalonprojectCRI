...
WebUI.mouseOver(findTestObject('ProductPageLayout/Testingproduct'))

WebUI.click(findTestObject('ProductPageLayout/Page_Testing Product/ProductPageLayout/Left_arrow'))
...
try {
    WebUI.verifyElementVisible(findTestObject('Object Repository/CommonTestCases/Page_Login (1)/Page_Testing Product/notvisibleproduct'), 
        0)
}
catch (Exception e) {
    KeywordUtil.markFailed('Element not visible')
} 
