...
WebElement byPrice = DriverFactory.getWebDriver().findElement(By.xpath('//div[@data-type="price"]//h5[@data-title="Price"]'))

if(byPrice.isDisplayed()) {
	
	println("By Price is Displayed")
}else {
	KeywordUtil.markFailed("By Price is not Displayed")
}
