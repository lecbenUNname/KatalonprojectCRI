...
WebUI.setText(findTestObject('Object Repository/ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/Phone_Locator'), '9898989')
...
if (failure_message.contains('The phone must be at least 8 characters.')) {
