...
String generateRandomString1(int length) {
	def characters1 = 'QAZWSDCEFVRGBTHNYJMUKilopasdfghjkzxcvbn'
...
clickElementWithRobot(findTestObject('Object Repository/FillingUpUserDetail/FillingUpUserDetails/Page_Register/button_Register'))
clickElementWithRobot(findTestObject('Object Repository/FillingUpUserDetail/FillingUpUserDetails/Page_Register/button_Register'))
...
def clickElementWithRobot(TestObject to) {
	def element = WebUiBuiltInKeywords.findWebElement(to, 10)
	def point = element.location
	def robot = new Robot()
