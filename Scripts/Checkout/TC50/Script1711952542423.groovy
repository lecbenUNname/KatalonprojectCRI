...
WebUI.setText(findTestObject('Object Repository/Checkout/City_CheckoutPage'), '1234567890')

WebUI.setText(findTestObject('Object Repository/Checkout/Address_CheckoutPage'), 'zxcvbnmsdfghjkEwrtyuiopqwertyuisdfghjkcvbnm,xcvbzxcvbnmsdfghjkEwrtyuiopqwertyuisdfghjkcvbnm,xcvbzxcvbnmsdfghjkEwrtyuiopqwertyuisdfghjkcvbnm,xcvb')
...
if (trimmedUrl != (trimmedUrl2)) {
	...
	KeywordUtil.markFailed('Address text field accept more than 120 characters.')
