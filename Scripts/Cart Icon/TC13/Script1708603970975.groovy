...
WebUI.click(findTestObject('Object Repository/Cart Icon/Cart_Checkoutbutton'))

WebUI.scrollToPosition(0,200)

WebUI.mouseOver(findTestObject('Object Repository/Cart Icon/Cart_checkoutpage'))

WebElement element1 = WebUiBuiltInKeywords.findWebElement(findTestObject('Object Repository/Cart Icon/Cart_checkoutpage'),
	0)
