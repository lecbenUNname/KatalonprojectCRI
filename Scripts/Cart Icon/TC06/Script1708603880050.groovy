...
WebElement element1 = WebUiBuiltInKeywords.findWebElement(findTestObject('Object Repository/Cart Icon/Cart_product name'),0)

highlightElement(element1)


WebUI.click(findTestObject('Object Repository/Cart Icon/Cart_product name'))
