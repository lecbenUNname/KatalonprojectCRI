...
for (int i = 0; i <= numberOfClicks; i++) {
    WebUI.click(findTestObject('Object Repository/ProductPageLayout/TC11_Rightarrow_button'))

    WebUI.delay(2)

    WebUI.click(findTestObject('Object Repository/ProductPageLayout/TC_11Leftarrowbutton'))
}
