...
String Actaual = WebUI.getAttribute(findTestObject('Object Repository/ProductPageLayout/Page_Testing Product/ProductPageLayout/Close_Button'), 'title')

String Expected = 'Close (Esc)'

WebUI.verifyMatch(Actaual, Expected, false)
