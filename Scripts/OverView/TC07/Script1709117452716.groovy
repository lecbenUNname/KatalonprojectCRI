...
WebUI.click(findTestObject('CommonTestCases/mouseoveruserimage'))

WebUI.click(findTestObject('Object Repository/OverView/Page_Account information/i_Account information_fi-rs-edit fs-6'))
