...
boolean x = WebUI.verifyElementClickable((findTestObject('Object Repository/QuickView/Modalclosebtn')), FailureHandling.OPTIONAL)

if (x) {

	
	CustomKeywords.'com.helper.common.Common_Helper.highlightElement'(findTestObject('Object Repository/QuickView/Modalclosebtn'))
