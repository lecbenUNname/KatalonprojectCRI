...
WebUI.setText(findTestObject('Object Repository/ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/Phone_Locator'), '6787668765')
...
WebUI.setText(findTestObject('Object Repository/ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/input_Address_address'),
	'Test for Address field should not accept more than 120 characters.Test for Address field should not accept more than 120 characters.Test for Address field should not accept more than 120 characters.')
...
if (failure_message.contains('The address must not be greater than 120 characters.')) {
