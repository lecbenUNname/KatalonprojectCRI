...
WebUI.verifyElementPresent(findTestObject('Object Repository/Compare Functionality/CompareHighlight/To compare list successfully'),0)
 ...
 String successToaster = WebUI.getText(findTestObject('Object Repository/Compare Functionality/CompareHighlight/To compare list successfully'))
    ...
    if (!successToaster.equals('Added product Women Yellow Bandhani Printed Maxi Dress to compare list successfully!')) {
