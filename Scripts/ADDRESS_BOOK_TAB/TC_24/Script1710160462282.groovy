...
WebUI.setText(findTestObject('Object Repository/ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/Phone_Locator'), 'Testnumber')
...
if (failure_message.contains('The phone format is invalid.')) {
