...
String a = WebUI.getText(findTestObject('Profiletab/Update_toaster'))

String b = "Profile updated successfully"

try {
    WebUI.verifyMatch(a, b, false)
	println("the toaster message is correct")
}
catch (Exception e) {
    KeywordUtil.markFailed('FAil')
	println("the toaster message is incorrect")
