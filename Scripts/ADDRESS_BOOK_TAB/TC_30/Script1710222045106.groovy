...
WebUI.setText(findTestObject('Object Repository/ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/Phone_Locator'), '0000000000')
...
failure_message = WebUI.getAttribute(findTestObject('ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/Address_Created_sucess'),
	'class')
...
if (failure_message.contains('danger')) {
