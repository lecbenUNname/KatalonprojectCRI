...
WebUI.waitForElementPresent(findTestObject('Object Repository/Company/Page_Contact/div_input-style mb-20'), 0)

String a='good'

WebUI.setText(findTestObject('Object Repository/Company/Page_Contact/input_name'), '                                           '+a)

String b = WebUI.getAttribute(findTestObject('Object Repository/Company/Page_Contact/input_name'), 'Placholder')
println(b)
