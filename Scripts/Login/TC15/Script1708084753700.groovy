...
WebUI.setEncryptedText(findTestObject('Object Repository/Login/Page_Login/input_Create one_password'), 'paIXsFo7LUGHnDORFS0x3qMnth45UKcNdxL82NlTTWL1ocb+oruiNFwYO3XfmqwrJE7zyAHuhAg=')

WebUI.click(findTestObject('Object Repository/Login/Page_Login/button_Login'))

WebUI.scrollToElement(findTestObject('Login/Page_Login/h1_Login'), 0)

String y = WebUI.getUrl()
