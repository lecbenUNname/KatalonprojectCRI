...
WebUI.setText(findTestObject('Object Repository/Checkout/FullName_Checkoutpag'), generateRandomchar(40))
...
if (Get_URL_checkout != (Get_URL_if_Checkout)) {
	...
	KeywordUtil.markFailed("The fullname text field accepts more than 35 characters")
}
