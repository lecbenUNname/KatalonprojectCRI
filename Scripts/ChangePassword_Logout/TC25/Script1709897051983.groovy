...
WebUI.click(findTestObject('Object Repository/ChangePassword/Page_Account information/a_Logout'))
...
WebUI.mouseOver(findTestObject('ChangePassword/Page_classicculture/AccountButton'))

WebUI.click(findTestObject('Object Repository/ChangePassword/Page_classicculture/a_Sign out'))
