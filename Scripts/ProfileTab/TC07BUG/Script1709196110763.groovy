...
WebUI.setText(findTestObject('Object Repository/Profiletab/Page_Profile/input_name'), 'rajarajakannapparprasanthkumarvarman')
...
if (WebUI.verifyElementPresent(findTestObject('Object Repository/Profiletab/SuccessALert'), 0)) {
    KeywordUtil.markFailed('Name field accepts more than 30 characters')
}
