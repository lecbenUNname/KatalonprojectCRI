...
WebUI.setText(findTestObject('Object Repository/Checkout/address_phone_CheckoutPage'), generateRandomchar(6))
...
if (trimmedUrl != (trimmedUrl2)) {
	...
	KeywordUtil.markFailed("Phone number field accepts alphabets.")
}
