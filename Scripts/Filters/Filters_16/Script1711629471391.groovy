...
WebElement byBrand = DriverFactory.getWebDriver().findElement(By.xpath('//h5[@data-title="Brand"]'))

if(byBrand.isDisplayed()) {
	
	println("By Brands is Displayed")
}else {
	
	KeywordUtil.markFailed("By Brands is not Displayed")
}
