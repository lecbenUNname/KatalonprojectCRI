...
WebUI.setText(findTestObject('Object Repository/Checkout/State_CheckoutPage'), 'G')
...
if (trimmedUrl != (trimmedUrl2)) {
	...
	KeywordUtil.markFailed("The state text field accepting the single character. ")
