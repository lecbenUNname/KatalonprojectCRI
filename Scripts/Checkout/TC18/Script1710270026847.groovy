...
WebUI.setText(findTestObject('Object Repository/Checkout/Email_CheckoutPage'), generateRandomSpc(5)+generateRandomSpc(3)+generateRandomEmail())
...
CustomKeywords.'com.helper.common.Common_Helper.highlightElement'(findTestObject('Object Repository/Checkout/Email_CheckoutPage'))
...
if (trimmedUrl == (trimmedUrl2)) {
	...
	KeywordUtil.markFailed("Email Field does not accept num-special character combinations")
}
...
String generateRandomEmail() {
	...
	def randomName = new Random().nextInt(10000)
