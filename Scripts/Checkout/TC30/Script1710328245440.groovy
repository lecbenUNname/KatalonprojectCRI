...
WebUI.setText(findTestObject('Object Repository/Checkout/address_phone_CheckoutPage'), generateRandomNo(9))
...
if (trimmedUrl != (trimmedUrl2)) {
	...
	KeywordUtil.markFailed("Phone number field  accepts null and dummy number.")
}
