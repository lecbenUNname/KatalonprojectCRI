...
for (int i = 0; i <= clickcount; i++) {
    WebUI.click(findTestObject('Object Repository/ProductPageLayout/qut_Up_Button'))

    WebUI.delay(3)

    WebUI.click(findTestObject('Object Repository/ProductPageLayout/Qut_down_Button'))
}
