...
String Validation_msg = WebUI.getAttribute(findTestObject('Object Repository/ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/Country_Locator'), 'validationMessage')

println(Validation_msg)

if (Validation_msg.contains("Please select an item in the list.")) {
