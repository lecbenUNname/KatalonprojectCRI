...
WebUI.setText(findTestObject('Object Repository/Checkout/address_phone_CheckoutPage'), generateRandomSpcchar(6))
...
if (trimmedUrl != (trimmedUrl2)) {
	...
	KeywordUtil.markFailed("Phone number field should accept special characters.")
}
