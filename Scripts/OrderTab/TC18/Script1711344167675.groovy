...
WebUI.click(findTestObject('OrderTab/Page_Orders/Page2'))

WebUI.scrollToPosition(0, 500)

WebUI.click(findTestObject('OrderTab/Page_Orders/PageLeftArrow'))

WebUI.scrollToPosition(0, 500)

WebUI.click(findTestObject('OrderTab/Page_Orders/PageRightArrow'))
