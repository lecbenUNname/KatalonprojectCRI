...
WebUI.verifyElementPresent(findTestObject('Object Repository/Profiletab/Page_Profile/div_Date of birth'), 0)

WebElement element = WebUiBuiltInKeywords.findWebElement(findTestObject('Object Repository/Profiletab/Page_Profile/div_Date of birth'), 
    30)
