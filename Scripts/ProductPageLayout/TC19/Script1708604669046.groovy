...
WebUI.mouseOver(findTestObject('Object Repository/ProductPageLayout/Page_Testing Product/button_'))

WebUI.click(findTestObject('Object Repository/ProductPageLayout/Page_Testing Product/button_'))
