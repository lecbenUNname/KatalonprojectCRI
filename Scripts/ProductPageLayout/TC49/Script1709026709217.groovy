...
WebUI.mouseOver(findTestObject('Object Repository/ProductPageLayout/Page_Testing Product/ProductPageLayout/Page_Blue Floral Printed Maxi Dress/Semistichedcholixpath'))

WebUI.click(findTestObject('Object Repository/ProductPageLayout/Page_Testing Product/ProductPageLayout/Page_Lehanga Choli/a_Add_action-btn hover-up js-add-to-compare-button'))
