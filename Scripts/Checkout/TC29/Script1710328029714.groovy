...
WebUI.setText(findTestObject('Object Repository/Checkout/address_phone_CheckoutPage'), '')
...
if (trimmedUrl != (trimmedUrl2)) {
	...
	KeywordUtil.markFailed("Phone number field should accept all characters")
}
