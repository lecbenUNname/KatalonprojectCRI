...
WebUI.setText(findTestObject('Object Repository/Checkout/FullName_Checkoutpag'), generateRandomchar(3)+'            '+generateRandomchar(3))
...
if (trimmedUrl != (trimmedUrl2)) {
   WebUI.takeScreenshot()
    KeywordUtil.markFailed("The full name text field accepting than one spance in between two names")
}
