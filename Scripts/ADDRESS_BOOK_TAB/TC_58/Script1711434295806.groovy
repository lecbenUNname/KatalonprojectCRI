...
Sucess_message = WebUI.getText(findTestObject('ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/Address_Created_sucess'))

println(Sucess_message)

WebUI.verifyMatch(Sucess_message, 'Created successfully', false,FailureHandling.CONTINUE_ON_FAILURE)
