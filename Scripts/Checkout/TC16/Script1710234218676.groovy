...
WebUI.setText(findTestObject('Object Repository/Checkout/Email_CheckoutPage'), generateRandomNo(2)+generateRandomSPc(2)+generateRandomEmail())
...
if (trimmedUrl == (trimmedUrl2)) {
	...
	KeywordUtil.markFailed("Email Field does not accept alpha-num-special character combinations")
}
