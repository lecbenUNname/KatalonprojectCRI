...
String Validation_msg = WebUI.getAttribute(findTestObject('Object Repository/ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/input_City_city'), 'validationMessage')
