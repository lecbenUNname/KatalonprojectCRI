...
WebUI.setText(findTestObject('Object Repository/Checkout/State_CheckoutPage'), '!@#$%^&*()_+-=')
...
if (trimmedUrl != trimmedUrl2) {
    ...
    KeywordUtil.markFailed('The state text field accepting the special character.')
