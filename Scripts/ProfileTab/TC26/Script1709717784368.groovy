...
WebUI.setText(findTestObject('Object Repository/Profiletab/Page_Profile/input_phone'), '87654321')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Profiletab/Page_Profile/div_Update profile successfully'), 
    0)

WebElement element = WebUiBuiltInKeywords.findWebElement(findTestObject('Object Repository/Profiletab/Page_Profile/div_Update profile successfully'), 
    30)
