...
Update_message = WebUI.getText(findTestObject('Object Repository/ADDRESS_BOOK_TAB/Address Book Object/Page_Address books/Updated_alert_locator'))

println(Update_message)

WebUI.verifyMatch(Update_message, 'Updated successfully', false,FailureHandling.CONTINUE_ON_FAILURE)
