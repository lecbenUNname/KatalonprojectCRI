...
WebUI.setText(findTestObject('Object Repository/Checkout/FullName_Checkoutpag'), generateRandomNo(10))
...
WebUI.setText(findTestObject('Object Repository/Checkout/Address_CheckoutPage'), generateRandomNo(1)+'no 56/34 bv nager')
...
if (trimmedUrl != (trimmedUrl2)) {
  WebUI.takeScreenshot()
   KeywordUtil.markFailed("The full name text field accepting numbers")
}
