...
WebUI.click(findTestObject('Object Repository/OrderTab/Page_Order detail 10000636/a_Download invoice'))

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/OrderTab/Page_Order detail 10000636/div_Profile Image     New image        Clos_268581'))
