...
WebUI.mouseOver(findTestObject('Compare Functionality/CompareHighlight/Compare In QucikView'))
...
if (pseudoElementContent.contains('Add To Compare')) {
    println('The parent element has ::after pseudo-element. Content: ' + pseudoElementContent)
