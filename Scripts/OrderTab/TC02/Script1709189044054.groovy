...
WebUI.verifyElementPresent(findTestObject('Object Repository/OrderTab/Page_Account information/a_Orders'), 0)

WebUI.click(findTestObject('Object Repository/OrderTab/Page_Account information/a_Orders'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('Object Repository/OrderTab/Page_Orders/a_Orders'), 0)
