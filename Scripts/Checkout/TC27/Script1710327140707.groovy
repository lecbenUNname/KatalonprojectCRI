...
WebUI.setText(findTestObject('Object Repository/Checkout/address_phone_CheckoutPage'), generateRandomNo(7))
...
if (trimmedUrl != (trimmedUrl2)) {
	...
	KeywordUtil.markFailed("Phone number field  accept below 8 numbers")
}
