...
WebElement element = WebUiBuiltInKeywords.findWebElement(findTestObject('BrowserAllCategories/OrderReturnReques/Page_Account information/Page_classicculture/Page_Order Return Requests/div_Return Product(s) Information Request number  10000009 Order Id  10000529'), 
    30)
