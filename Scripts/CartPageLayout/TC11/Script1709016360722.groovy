...
if (WebUI.verifyElementPresent(findTestObject('CartLayout/AddToCartButtonInProductPage'), 0)) {
    WebElement element = WebUiBuiltInKeywords.findWebElement(findTestObject('CartLayout/AddToCartButtonInProductPage'), 
        30)
    ...
    KeywordUtil.markFailed('Failed because add to cart is not visibly displayed')
