...
boolean x = WebUI.verifyElementClickable(findTestObject('Object Repository/QuickView/QVqtyUpicon'), FailureHandling.OPTIONAL)

boolean y = WebUI.verifyElementClickable(findTestObject('Object Repository/QuickView/QVqtyDownIcon'), FailureHandling.OPTIONAL)

boolean k =x && y

if(k) {
WebUI.click(findTestObject('Object Repository/QuickView/QVqtyUpicon'))

WebUI.click(findTestObject('Object Repository/QuickView/QVqtyDownIcon'))
}
