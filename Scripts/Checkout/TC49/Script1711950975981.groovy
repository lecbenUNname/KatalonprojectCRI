...
WebUI.setText(findTestObject('Object Repository/Checkout/Address_CheckoutPage'), 'a')
...
if (trimmedUrl != (trimmedUrl2)) {
	...
	KeywordUtil.markFailed('The address text field accepting the single character. ')
