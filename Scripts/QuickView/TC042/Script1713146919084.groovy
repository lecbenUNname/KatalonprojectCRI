...
WebUI.click(findTestObject('Object Repository/QuickView/QVcmprIcon'))

boolean x = WebUI.verifyElementPresent(findTestObject('Object Repository/QuickView/QVsucessToast'),1, FailureHandling.OPTIONAL)
