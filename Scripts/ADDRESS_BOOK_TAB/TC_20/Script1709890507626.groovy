...
WebUI.setText(findTestObject('ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/Email_Locator'), 'tes   t@gmail.com')
...
if (Validation_msg.contains("A part followed by '@' should not contain the symbol ' '.")) {
