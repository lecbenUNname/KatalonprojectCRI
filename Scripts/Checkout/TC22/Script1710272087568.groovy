...
WebUI.setText(findTestObject('Object Repository/Checkout/Email_CheckoutPage'), '                  ')
...
if (trimmedUrl != (trimmedUrl2)) {
	...
	KeywordUtil.markFailed("Accepting space in the email ID text field. But the alert is showing in new page. Its like a coding page")
}
