...
WebUI.setText(findTestObject('Object Repository/ADDRESS_BOOK_TAB/Address Book Object/Page_Create Address/Phone_Locator'), '9898989765456787')
...
if (failure_message.contains('The phone must not be greater than 15 characters.')) {
