...
WebUI.click(findTestObject('Object Repository/ChangePassword/Page_Change Password/input_Current password_old_password'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Object Repository/ChangePassword/Page_Change Password/input_Current password_old_password'), 
    Keys.chord(Keys.TAB))
