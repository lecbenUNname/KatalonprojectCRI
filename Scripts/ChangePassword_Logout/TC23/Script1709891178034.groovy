...
WebUI.sendKeys(findTestObject('ChangePassword/Page_Change Password/input_Current password_old_password'), Keys.chord(Keys.TAB))

WebUI.setEncryptedText(findTestObject('Object Repository/ChangePassword/Page_Change Password/input_New password_password'), 
    'aeHFOx8jV/A=')

WebUI.sendKeys(findTestObject('ChangePassword/Page_Change Password/input_New password_password'), Keys.chord(Keys.TAB))
...
WebUI.sendKeys(findTestObject('ChangePassword/Page_Change Password/input_Password confirmation_password_confirmation'), 
    Keys.chord(Keys.TAB))

WebUI.sendKeys(findTestObject('Object Repository/ChangePassword/Page_Change Password/button_Change password'), Keys.chord(
        Keys.ENTER))
