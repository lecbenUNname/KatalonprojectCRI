...
WebUI.mouseOver(findTestObject('ProductPageLayout/Page_Testing Product/ProductPageLayout/Page_Blue Floral Printed Maxi Dress/Semistichedcholixpath'))

WebUI.click(findTestObject('ProductPageLayout/Product_wishlist_Button'))

WebUI.scrollToPosition(0, 50)

WebUI.click(findTestObject('Object Repository/ProductPageLayout/Wishlist'))

WebUI.click(findTestObject('Object Repository/ProductPageLayout/wishlist_delete_button'))
