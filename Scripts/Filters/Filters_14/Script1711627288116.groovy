...
WebElement advancedFilter = DriverFactory.getWebDriver().findElement(By.xpath("//a[@class='show-advanced-filters']"))

boolean displayed = advancedFilter.isDisplayed()

if(displayed) {
	
	println("Advance filter dispalyed")

	}else {
		println("Advance filter not dispalyed")
