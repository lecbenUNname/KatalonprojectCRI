...
WebUI.verifyElementPresent(findTestObject('Filters/Filter_Categories'), 0)

CustomKeywords.'com.helper.common.CommonMethod.highlightElement'(findTestObject('Filters/Filter_Categories'))
