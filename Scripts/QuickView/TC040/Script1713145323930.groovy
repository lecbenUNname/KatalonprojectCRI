...
boolean x = WebUI.verifyElementClickable(findTestObject('Object Repository/QuickView/QVwshLstIcon'), FailureHandling.OPTIONAL)

if (x) {

	WebUI.click(findTestObject('Object Repository/QuickView/QVwshLstIcon'))
...
WebUI.click(findTestObject('Object Repository/QuickView/HeaderWshLstIcon'))
...
CustomKeywords.'com.helper.common.CommonMethod.logout'()
